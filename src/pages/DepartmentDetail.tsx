...
const DepartmentDetail = () => {
  ...
  const departmentFundings = sampleFundings.filter(
    (funding) =>
      funding.department === departmentId && funding.state === stateId
  );
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <Card className="bg-gradient-card shadow-card">
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {
                    departmentFundings.filter((f) => f.status === "completed")
                      .length
                  }
                </div>
                <p className="text-xs text-muted-foreground">
        ...
        <div className="space-y-6">
          ...
          <Card className="shadow-card">
            <CardHeader>
              ...
              <CardDescription>
                All transactions are verified on the blockchain for maximum
                transparency
              </CardDescription>
            </CardHeader>
            <CardContent>
              {departmentFundings.length > 0 ? (
                        ...
                        <TableCell className="font-mono text-sm">
                          <div className="flex items-center space-x-2">
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                copyToClipboard(funding.transactionId)
                              }
                ...
                <div className="text-center py-8">
                  <p className="text-muted-foreground">
                    No funding transactions found for this department.
                  </p>
                  <p className="text-sm text-muted-foreground mt-2">
                    This could mean no recent activity or data is still being
                    indexed.
                  </p>
                </div>
              )}
